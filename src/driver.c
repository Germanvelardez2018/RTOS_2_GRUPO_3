...
void driver_init(driver_t *driver)
{
	...
	init_queues(driver); //Se crean las colas de Tx y Rx para pasar los datos a la capa 3.

	init_memory(driver); //Se pide memoria y se crea el pool donde se almacenaran los datos recibidos.
